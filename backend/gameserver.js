...
app.post("/register", (req, res) => {
    ...
    if (modGame.validDate(req.body)){
        ...
        fs.writeFile(jsonplayes, JSON.stringify(dbplayes,false,1), 'utf8', err=>{if(err)console.log(err)});
        fs.writeFile(jsonscores, JSON.stringify(dbscores,false,1), 'utf8', err=>{if(err)console.log(err)});
